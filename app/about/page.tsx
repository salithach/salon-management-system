    ...
    const pillars = [
        {
            ...
            body: "Smart appointments, update status based on feedback — so your team focuses on clients, not admin.",
        ...
        },
        {
            ...
            body: "Daily assignments, manage jobs and revenue insights — all unified under one clean dashboard.",
        ...
        <main className="bg-slate-950 text-slate-100 min-h-screen">
            ...
            <section className="max-w-6xl mx-auto px-6 py-28 grid md:grid-cols-2 gap-16 items-center bg-slate-950">
                <div>
                    ...
                    <p className="text-slate-400 leading-relaxed mb-5 text-[15px]">
                        SalonHQ started when our founders — when it was found that salon owners were
                        juggling through apps, a paper book, and a group chat just to run one staff.
                        They set out to build the software they always wished existed.
                    </p>
                    <p className="text-slate-400 leading-relaxed text-[15px]">
                        Today, SalonHQ can be used for scheduling appointments, staff management,
            ...
            <section className="relative overflow-hidden bg-linear-to-br from-slate-950 via-blue-950/60 to-slate-950 px-6 py-28 text-center border-t border-white/5">
                ...
                <div className="relative max-w-2xl mx-auto">
                    ...
                    <p className="text-blue-200 max-w-md mx-auto mb-10 text-sm leading-relaxed">
                        Join with SalonHQ. No contracts. Cancel anytime.
                    </p>
                    <a href="/contact"
