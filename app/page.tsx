...
const services = [
  { label: "Haircut & Blowout",   emoji: "✂️",  color: "from-teal-500/5 to-emerald-500/5 border-white/5 hover:border-teal-500/40 hover:bg-teal-500/10" },
  ...
  { label: "Manicure & Pedicure", emoji: "💅",  color: "from-pink-500/5 to-teal-500/5 border-white/5 hover:border-pink-500/40 hover:bg-pink-500/10" },
  { label: "Facial Treatments",   emoji: "🧖",  color: "from-teal-500/5 to-emerald-500/5 border-white/5 hover:border-emerald-500/40 hover:bg-emerald-500/10" },
  { label: "Lash Extensions",     emoji: "👁️",  color: "from-teal-500/5 to-cyan-500/5 border-white/5 hover:border-teal-500/40 hover:bg-teal-500/10" },
  { label: "Eyebrow Threading",   emoji: "🪡",  color: "from-emerald-500/5 to-teal-500/5 border-white/5 hover:border-emerald-500/40 hover:bg-emerald-500/10" },
  { label: "Deep Conditioning",   emoji: "💆",  color: "from-cyan-500/5 to-teal-500/5 border-white/5 hover:border-cyan-500/40 hover:bg-cyan-500/10" },
  { label: "Nail Art",            emoji: "🖌️",  color: "from-teal-500/5 to-pink-500/5 border-white/5 hover:border-teal-500/40 hover:bg-teal-500/10" },
];
...
const whyItems = [
  ...
  { icon: Clock,    title: "Always in sync",    desc: "Real-time updates across all devices and staff members.", gradient: "from-cyan-500 to-teal-500" },
  { icon: Sparkles, title: "Beautiful UI",      desc: "A clean, modern interface your whole team will love.", gradient: "from-teal-400 to-emerald-500" },
];
...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-950 text-slate-100 font-sans">
      ...
      {/* ── Hero ── */}
      <section className="relative overflow-hidden bg-linear-to-br from-slate-950 via-teal-950/40 to-slate-950 pt-32 pb-28 px-6">
        {/* Decorative glow orbs */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-225 h-125 bg-teal-600/15 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute bottom-0 right-1/4 w-125 h-87.5 bg-emerald-600/15 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute top-1/3 left-0 w-75 h-75 bg-cyan-600/10 rounded-full blur-3xl pointer-events-none" />

        <div className="relative max-w-4xl mx-auto text-center flex flex-col items-center gap-7">
          <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-teal-300 bg-teal-500/10 border border-teal-500/25 px-4 py-1.5 rounded-full backdrop-blur-sm">
            <Sparkles size={11} className="text-teal-400" /> Next-generation salon management
          </span>
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold leading-[1.08] tracking-tight text-white">
            Run your salon
            <br />
            <span className="bg-linear-to-r from-teal-400 via-emerald-400 to-cyan-405 bg-clip-text text-transparent">
              without the chaos.
            </span>
          </h1>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 pt-1">
            <Link href="/register"
              className="group flex items-center gap-2 bg-linear-to-r from-teal-600 to-emerald-600 hover:from-teal-500 hover:to-emerald-500 text-white text-sm font-semibold px-7 py-3.5 rounded-full transition-all shadow-lg shadow-teal-950/50 hover:shadow-teal-900/50 hover:-translate-y-0.5">
              Get Started Free
      ...
      {/* ── Stats Banner ── */}
      <section className="bg-linear-to-r from-teal-950/60 via-slate-900 to-teal-950/60 border-y border-white/5 py-14 px-6">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-white tracking-tight">
              ...
              <span className="bg-linear-to-r from-teal-400 to-emerald-400 bg-clip-text text-transparent">needs</span>
            </h2>
                ...
                {features.map((f) => {
                  ...
                  return (
                    <div key={f.title} className="min-w-full px-2">
                      <div className={`group bg-white/5 border border-white/10 rounded-2xl p-9 flex flex-col gap-5 max-w-lg mx-auto hover:border-teal-500/30 hover:bg-white/10 hover:shadow-xl ${f.glow} transition-all duration-300`}>
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-xs font-semibold uppercase tracking-widest text-teal-300 bg-teal-500/10 border border-teal-400/20 px-3 py-1 rounded-full">
                            {f.tag}
                          </span>
                        </div>
            ...
            {[{ dir: "prev", cls: "-left-5", fn: feat.prev, Icon: ChevronLeft },
              ...
              .map(({ dir, cls, fn, Icon }) => (
                <button key={dir} onClick={fn}
                  className={`absolute ${cls} top-1/2 -translate-y-1/2 w-11 h-11 rounded-full bg-slate-800 border border-white/10 shadow-md flex items-center justify-center hover:border-teal-400 hover:shadow-teal-500/20 transition-all`}>
          ...
          <div className="flex items-center justify-center gap-2 mt-8">
            {features.map((_, i) => (
              <button key={i} onClick={() => feat.setIndex(i)}
                 className={`rounded-full transition-all duration-300 ${i === feat.index ? "w-7 h-2.5 bg-linear-to-r from-teal-500 to-emerald-500" : "w-2.5 h-2.5 bg-slate-700 hover:bg-slate-600"}`} />
            ))}
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-white tracking-tight">
              ...
              <span className="bg-linear-to-r from-teal-400 to-emerald-400 bg-clip-text text-transparent">you offer</span>
            </h2>
      ...
      {/* ── Why SalonHQ ── */}
      <section className="relative overflow-hidden py-28 px-6 bg-linear-to-br from-slate-950 via-teal-950/40 to-slate-900">
        <div className="absolute top-0 right-0 w-150 h-100 bg-teal-600/10 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-100 h-75 bg-emerald-600/10 rounded-full blur-3xl pointer-events-none" />
        <div className="relative max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <span className="inline-block text-xs font-semibold uppercase tracking-widest text-teal-300 bg-teal-500/10 border border-teal-500/20 px-4 py-1.5 rounded-full mb-5">
              Why Us
            </span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {whyItems.map((w) => {
              const Icon = w.icon;
              return (
                <div key={w.title} className="group bg-white/5 border border-white/10 rounded-2xl p-7 hover:bg-white/10 hover:border-teal-500/20 transition-all hover:-translate-y-1">
      ...
      <section className="py-28 px-6 bg-linear-to-b from-slate-950 to-slate-900">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-white tracking-tight">
              Loved by salon{" "}
              <span className="bg-linear-to-r from-teal-400 to-emerald-400 bg-clip-text text-transparent">professionals</span>
            </h2>
          ...
          <div className="relative">
              ...
              <div className="flex transition-transform duration-500 ease-in-out"
                ...
                {testimonials.map((t) => (
                  <div key={t.name} className="min-w-full px-1">
                    <div className="bg-white/5 border border-white/10 rounded-2xl p-9 flex flex-col gap-5 shadow-sm hover:shadow-lg hover:border-teal-500/30 hover:bg-white/10 transition-all">
                      ...
                      <div className="flex items-center gap-3.5 pt-5 border-t border-white/10">
                        <div className="w-11 h-11 rounded-full bg-linear-to-br from-teal-600 to-emerald-600 text-white flex items-center justify-center text-sm font-bold shrink-0 shadow-md">
                          {t.name[0]}
                        </div>
                        <div>
            ...
            {[{ dir: "prev", cls: "-left-5", fn: test.prev, Icon: ChevronLeft },
              ...
              .map(({ dir, cls, fn, Icon }) => (
                <button key={dir} onClick={fn}
                  className={`absolute ${cls} top-1/2 -translate-y-1/2 w-11 h-11 rounded-full bg-slate-800 border border-white/10 shadow-md flex items-center justify-center hover:border-teal-400 transition-all`}>
                  <Icon size={16} className="text-slate-300" />
                </button>
              ))}
          </div>
          ...
          <div className="flex items-center justify-center gap-2 mt-8">
            {testimonials.map((_, i) => (
              <button key={i} onClick={() => test.setIndex(i)}
                 className={`rounded-full transition-all duration-300 ${i === test.index ? "w-7 h-2.5 bg-linear-to-r from-teal-500 to-emerald-500" : "w-2.5 h-2.5 bg-slate-700 hover:bg-slate-600"}`} />
            ))}
          </div>
        </div>
      </section>
      ...
      {/* ── CTA ── */}
      <section className="relative overflow-hidden py-28 px-6 bg-linear-to-br from-slate-950 via-teal-950/60 to-slate-950 border-t border-white/5">
        ...
        <div className="absolute -bottom-20 -right-20 w-125 h-125 bg-teal-600/10 rounded-full blur-3xl pointer-events-none" />
        <div className="relative max-w-3xl mx-auto text-center flex flex-col items-center gap-7">
          <span className="inline-block text-xs font-semibold uppercase tracking-widest text-teal-200 bg-white/5 border border-white/10 px-4 py-1.5 rounded-full backdrop-blur-sm">
            Get Started
          </span>
          ...
          <ul className="flex flex-col sm:flex-row gap-5 text-sm text-teal-200/80">
          ...
          <div className="flex flex-wrap gap-3 justify-center pt-1">
            <Link href="/register"
              className="group flex items-center gap-2 bg-white text-teal-950 text-sm font-bold px-8 py-3.5 rounded-full hover:bg-teal-50 transition-all shadow-xl hover:-translate-y-0.5">
              Start Free Trial
              <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link href="/about"
              className="text-teal-200 hover:text-white text-sm font-medium px-8 py-3.5 rounded-full border border-white/20 hover:border-white/40 backdrop-blur-sm transition-all hover:-translate-y-0.5">
              Learn More
            </Link>
          </div>
        </div>
